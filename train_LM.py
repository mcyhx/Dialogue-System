...
class Trainer(object):
    def __init__(self):
        self.data = self.data_reader(os.path.join(root_path, 'data/ranking/train.csv')) + \
            self.data_reader(os.path.join(root_path, 'data/ranking/dev.csv')) + \
            self.data_reader(os.path.join(root_path, 'data/ranking/test.csv'))
